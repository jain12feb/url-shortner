  ...
  ({ className, onClick, ...props }, ref) => (
    <AlertDialogPrimitive.Action
      ...
      className={cn(
        ...
        (className =
          "rounded-full bg-destructive text-white font-bold hover:bg-red-600"),
        className
      )}
      {...props}
    />
...
const AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "rounded-full bg-white text-black hover:bg-yellow-100",
      className
    )}
    {...props}
  />
